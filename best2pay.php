...
/* КОНЕЦ БЛОКА НАСТРАИВАЕМЫХ ПАРАМЕТРОВ */
    ...
    public function getNotification() {
		...
		$best2pay_id = file_get_contents($this->getURL('/webapi/Register'), false, $context);
...
<input type='hidden' name='signature' value='<?php echo base64_encode(md5($this->sector.$best2pay_id.$this->password))?>'>
<p><img src="//www.best2pay.net/assets/mytemplate/img/logo.png" width="122" height="31" alt="Best2Pay" title="Платежная система Best2Pay" style="float:left; margin-right:0.5em; margin-bottom:0.5em; padding-top:0.25em;">
	Оплата по банковской карте осуществляется через платежную систему <b><a href="http://www.best2pay.net">Best2Pay</a></b>, обеспечивающую простой и безопасный способ оплаты по карте.
<?php if ($this->fee >= 0.01) { ?>
